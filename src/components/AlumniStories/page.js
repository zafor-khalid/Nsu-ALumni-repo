...
const page = () => {
    return (
        <>
            <h1 className="text-center my-5">Elon Musk
            </h1>
            <div className="text-light d-flex justify-content-center align-items-center p-5">

                <img className="mx-5" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Elon_Musk_Royal_Society_%28crop1%29.jpg/220px-Elon_Musk_Royal_Society_%28crop1%29.jpg" height="350px" width="300px" alt="" />
                <p style={{ textAlign: 'justify' }}>Elon Reeve Musk FRS (/ˈiːlɒn/ EE-lon; born June 28, 1971) is an entrepreneur and business magnate. He is the founder, CEO, and Chief Engineer at SpaceX; early stage investor,[note 2] CEO, and Product Architect of Tesla, Inc.; founder of The Boring Company; and co-founder of Neuralink and OpenAI. A centibillionaire, Musk is one of the richest people in the world.
